                        ...
                        <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                            ...
                            <div>
                                ...
                                <div className="flex my-3 mb-7">
                                    <Link to="/" className='text-xs font-semibold px-1'>NEW USER ? </Link>
                                </div>
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-5">
                                        <button onClick={handleSubmitLoginForm} className="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">LOGIN</button>
                                    </div>
                                </div>
                            </div>
                        </div>
